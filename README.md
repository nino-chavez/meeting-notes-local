...
| [`docs/journeys.md`](./docs/journeys.md) | What the operator does across days. Six journeys, why the unit is retrieval rather than the meeting, a market check on persona and IA, and ten gaps the state inventory could not show. |
