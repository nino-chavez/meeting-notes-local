...
| [`docs/journeys.md`](./docs/journeys.md) | What the operator does across days. Five journeys, why the unit is retrieval rather than the meeting, and eight gaps the state inventory could not show — three now resolved, five still open. |
