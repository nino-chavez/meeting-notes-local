...
def inside_repo(path: Path, repo: Path | None = None) -> bool:
    ...
    carries what was said and never belongs in source control — was learned the
    expensive way:
...
def _ground_truth_controls() -> bool:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        #     a transcript and never belongs in source control. Refused in the
        #     tool rather than left to .gitignore, which only covers paths someone
        #     thought of.
