...
| 2 | Operator voice isolation: guided enrollment, measured operating points, owner-only profile | J3 J5 | §I | **Registered (0.2.2)** — sittings, derivation, choices, profile build and publication; adoption into the live capture gate still **Open** (`profile.adopt` is boundary-lane only) |
